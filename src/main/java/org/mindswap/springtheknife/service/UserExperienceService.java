...
import org.mindswap.springtheknife.exceptions.*;
...
@Service
public class UserExperienceService implements UserExperienceServiceInterface {
    ...
    @Autowired
    public UserExperienceService(UserExperienceRepository userExperienceRepository, UserService userService, RestaurantService restaurantService) {
